...
// event-loop stall (8 at once measured ~218ms in which nothing polls), and
// each call sits under per-call blocking thresholds, so the burst is the
// cost. The callback form runs on the threadpool instead - and here the loop
// it stops freezing is also the poll loop.
